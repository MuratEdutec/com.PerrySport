...
public class ReusableMethods {
    ...
    public static String getScreenshot(String name) throws IOException {
        ...
        String target = System.getProperty("user.dir") + "/target/Screenshots/" + name + "_" + date + ".jpeg";
...
//   waitFor(5);  => waits for 5 second
    ...
    public static WebElement fluentWait(final WebElement webElement, int timeout) {
        ...
        FluentWait<WebDriver> wait = new FluentWait<WebDriver>(Driver.getDriver()).withTimeout(Duration.ofSeconds(3))//Wait 3 second each time
